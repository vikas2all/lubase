        ...
        static class DemoArticleFilter implements IArticleFilter {
                ...
                public void process(WikiArticle page, Siteinfo siteinfo) throws SAXException {
                        if (page.isMain() || page.isCategory() || page.isProject()) {
                                ...
                                wikiModel.setUp();
                                try {
                                        creator.renderToFile(new PlainTextConverter(),generatedHTMLFilename);
                                        //creator.
                                        System.out.print('.');
                                        if (++counter >= 80) {
                                                System.out.println(' ');
...
//                        }
//                }
                 String bz2Filename = "f:\\wiki\\enwiki-20121101-pages-articles.xml.bz2";
                //String bz2Filename = args[0];
                WikiDB db = null;

                try {
                        String mainDirectory = "e:/wikidump";
                        String htmlDirectory = "e:/wikidump/data/";

                        // the following directory must exist for image references
                        String imageDirectory = "e:/wikidump/WikiDumpImages";
