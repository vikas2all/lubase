...
//	    Map<String, byte[]> fieldsToStore = new HashMap<String, byte[]>();
	    ...
	    termPositions.entrySet().clear();
	    fieldsToStore.entrySet().clear();
	    termPositions.clear();
	    fieldsToStore.clear();
		...
		for (Fieldable field : doc.getFields()) {
	        ...
	        if (field.isIndexed() && field.isTokenized()) {
	          ...
	          while (tokens.incrementToken()) {
	            //String term1 = tokens.getAttribute(TermAttribute.class).term();
	            /**
	             * This is important! Otherwise the position is for the whole 
	             * document, not for fields.
	             */
	            String term = "/"+field.name()+"/"+tokens.getAttribute(TermAttribute.class).term();
	        ...
	        if (field.isStored()) {
	            byte[] value =  Bytes.toBytes(field.stringValue());
